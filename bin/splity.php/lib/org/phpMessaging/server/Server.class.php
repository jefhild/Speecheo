...
class org_phpMessaging_server_Server {
	...
	public function poll($name = null, $instanceName = null, $metaData = null) {
		...
		do {
			...
			if($message === null) {
				Sys::sleep($this->application->serverConfig->longPollingSleepDuration / 1000);
			}
		} while($message === null && $elapsedTimeMS < $this->application->serverConfig->longPollingDuration);
		if($message !== null) {
